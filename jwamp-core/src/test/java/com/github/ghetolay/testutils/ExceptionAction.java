...
public class ExceptionAction implements CallAction{

	public static URI uri = URIBuilder.uri("http://example.com/except");
	public static URI excptionUri = URIBuilder.uri("http://example.com/exceptions#testException");
	
	@Override
	public WampCallResultMessage handleCall(WampSession session, WampCallMessage msg) throws CallException {
		throw new CallException(excptionUri, "Standard exception");
	}
