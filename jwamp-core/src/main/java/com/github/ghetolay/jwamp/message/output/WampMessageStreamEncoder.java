 ...
 *
 */
public class WampMessageStreamEncoder implements Encoder.TextStream<WampMessage>{

	//private JsonFactory jsonFactory;

	@Override
	public void init(EndpointConfig config) {
		//TODO sometimes it return null when it shouldn't
		//this.jsonFactory = (JsonFactory) config.getUserProperties().get("jwamp.jsonfactory");
	}
	...
	@Override
	public void encode(WampMessage msg, Writer writer)
